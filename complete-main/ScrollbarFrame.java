...
public class ScrollbarFrame extends JPanel{
    JLabel j1;
    ...
    public ScrollbarFrame(String output){ 
       frame = new JFrame("About Our Books");
       //super(true);
